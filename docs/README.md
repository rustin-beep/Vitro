...
>
> 最后核对：2026-09-26（07 目录新增《kimicc外部参考调查报告20260926》、总计划排版 G-5/G-6 与两处注记；
> 前一沿革：2026-09-23 MoonBit 迁移现状对齐——基础文档补迁移现状声明；C++ 两份随砍 C++ 裁定归档；
> 索引修幽灵条目与重复条目、补 05 目录 4 份算法标注 golden 文档；更早：2026-09-22 新增脚本总清单专册、
> 构建指南环境要求随 D5 防线 Go 化更新；2026-09-13 归类翻新——current 全部文档逐个取证后重命名
