...
moon test                 # 205 测试（白盒 _wbtest.mbt + 黑盒 _test.mbt + doc 测试；数字为 2026-09-21 快照，真值以 facts `moonbit_test_passed` 为准）
