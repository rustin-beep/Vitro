...
内存布局与有界隔离图（由 `go run ./scripts/gen_svg` 生成，对账本决议与[内存安全规范 §3.4](../01-定位与路线/内存安全规范.md)）：

<p align="center"><img src="../01-定位与路线/memory-layout-quarantine.svg" alt="1MB 线性内存布局与堆有界隔离" width="900"></p>
