...
内存布局与有界隔离图（由 `go run ./scripts/gen_svg` 生成，对账本节与[堆有界隔离决议](../06-出口与协议/堆有界隔离决议.md)）：

<p align="center"><img src="memory-layout-quarantine.svg" alt="1MB 线性内存布局与堆有界隔离" width="900"></p>
